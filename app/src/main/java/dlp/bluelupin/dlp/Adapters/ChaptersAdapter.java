...
public class ChaptersAdapter extends RecyclerView.Adapter<ChaptersViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final ChaptersViewHolder holder, final int position) {
...
//                        }
    ...
    private void playVideoOnSelect(Data data, ChaptersViewHolder holder, String actionType) {
        if (data.getMedia_id() != 0) {
            final DbHelper dbHelper = new DbHelper(context);
    ...
    private void playAudioOnSelect(Data data, ChaptersViewHolder holder, String actionType) {
        if (data.getMedia_id() != 0) {
            final DbHelper dbHelper = new DbHelper(context);
            Data media = dbHelper.getMediaEntityByIdAndLaunguageId(data.getMedia_id(),
                    Utility.getLanguageIdFromSharedPreferences(context));
    ...
    private void navigateBasedOnMediaType(Data media, ChaptersViewHolder holder) {
        String url;
    ...
    private void openUrlOnSelect(Data data, ChaptersViewHolder holder, String actionType) {
        if (data.getUrl() != null) {
    ...
    private void DownloadImage(ChaptersViewHolder holder, Data media) {
        Gson gson = new Gson();
